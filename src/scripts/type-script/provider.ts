...
module Adf {
   ...
   export interface IColumn extends IRow {    
    }

   
   export interface IDashBoardServiceConfig extends ng.IServiceProvider {
        id?: number;
        widgets: any;
        structures: any;
        messageTemplate: any;
        loadingTemplate: any;
        widget: (name: string, widget:any) => any;
        structure : (name:string, structure:IStructure) => any;
   }
    

    export class Dashboard implements IDashBoardServiceConfig {
      ...
      <div class="progress progress-striped active">\n\
        ...
        /**
            ...
            loadingTemplate = (template:string)  => {
                this.loadingTemplate =<any> template;
                return this;
            };
